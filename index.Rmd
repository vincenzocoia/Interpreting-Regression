...
This book explores statistics from a problem-first perspective, a topic I like to call "statistical data science". The wider topic of data science is concerned with drawing insights from data, often relying on numerical quantities to be calculated and interpreted -- whether that quantity be a prediction, a regression coefficient, or a mean squared error. That part of the data science process that provides precise interpretation is the topic of this book. 

The book aims to cover foundational topics in statistical data science, spanning a variety of regression models that are often seen in practice, and tying them together. Of course, there are many, many more advanced statistical topics that will not be covered in this book, including spatial statistics, state space models, etc.
