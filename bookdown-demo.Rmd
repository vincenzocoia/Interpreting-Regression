...
<!--chapter:end:010-distributions.Rmd-->
...
<!--chapter:end:020-estimation.Rmd-->
...
<!--chapter:end:031-mean_as_ls.Rmd-->
...
```{r}
dat <- Teams %>% #tbl_df %>% 
  dplyr::rename(runs=R, hits=H)
  #dplyr::select(runs, hits)
dat <- dat[, c("runs", "hits")]
```
...
<!--chapter:end:032-probabilistic_forecasting.Rmd-->
...
<!--chapter:end:033-quantile_regression.Rmd-->
...
<!--chapter:end:041-ml_workflow-asking_questions.Rmd-->
...
<!--chapter:end:051-reducible_error.Rmd-->
...
<!--chapter:end:053-splines_and_loess_in_r.Rmd-->
...
<!--chapter:end:060-model_fitting-r.Rmd-->
...
<!--chapter:end:071-lm_in_general.Rmd-->
...
<!--chapter:end:072-reference-treatment_parameterization.Rmd-->
...
<!--chapter:end:079-non_identifiability_gams.Rmd-->
...
<!--chapter:end:091-logistic_regression_report_with_paul.Rmd-->

# DSCI 562 Lab 4 Tutorial: Robust Regression
...
<!--chapter:end:121-robust_in_r.Rmd-->
...
<!--chapter:end:141-missing_data_in_r.Rmd-->
...
<!--chapter:end:151-timeseries_objects_in_r.Rmd-->
