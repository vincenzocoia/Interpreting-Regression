...
library(tidyverse)
library(distplyr)
library(CopulaModel) # Currently can download from github.com/vincenzocoia/CopulaModel
...
tribble(
	...
	"Mean", as.character(round(flow$mean, 2)), as.character(round(snowflow$meancond(x0), 2)),
	"Median", as.character(round(flow$qdist(0.5), 2)), as.character(round(snowflow$qcond(0.5, x0), 2)),
	str_c(p*100, "% PI"), 
